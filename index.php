...
<body>
  ...
  <div class="container-fluid">
    <div class="col s12">
      ...
      <h4 style="text-align:center;">เดือน กรกฎาคม 2562 เวลา 13.30-16.30 น. ณ IT Hall อาคารไทยซัมมิททาวเวอร์ ถ.เพชรบุรีตัดใหม่</h4><br />
      <div class="card">
        ...
        <form id="form_survey" method="POST">
          ...
          <div class="card-body">
            ...
            <div>
              <label>
                <input class="with-gap" name="date_event" type="radio" value="วันอังคารที่ 23 กรกฎาคม 2562" required />
                <span for="">วันอังคารที่ 23 กรกฎาคม 2562</span>
              </label>

              <label>
                <input class="with-gap" name="date_event" type="radio" value="วันพฤหัสบดีที่ 25 กรกฎาคม 2562" required />
                <span for="">วันพฤหัสบดีที่ 25 กรกฎาคม 2562</span>
              </label>
            </div><br />
